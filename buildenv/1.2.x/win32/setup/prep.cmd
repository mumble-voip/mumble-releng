...
SET PATH=%MUMBLE_RELENG_ROOT%\mumble-releng;%PATH%
SET PATH=%MUMBLE_QT_PREFIX%\bin;%PATH%
SET PATH=%MUMBLE_OPENSSL_PREFIX%\bin;%PATH%
SET PATH=%MUMBLE_PROTOBUF_PREFIX%\vsprojects\Release;%PATH%
SET PATH=%MUMBLE_PREFIX%\sndfile\bin;%PATH%
SET PATH=%MUMBLE_PREFIX%\nasm;%PATH%
SET PATH=%MUMBLE_PREFIX%\zlib\lib;%PATH%
SET PATH=%MUMBLE_PREFIX%\MySQL\lib;%PATH%
SET PATH=%MUMBLE_ICE_PREFIX%\bin;%PATH%
cmd /V:ON /K %*
exit /b
