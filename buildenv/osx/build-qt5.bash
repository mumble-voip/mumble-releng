...
OPENSSL_LIBS="-L$MUMBLE_PREFIX/lib -lssl -lcrypto" ./configure -v -platform macx-clang -no-c++11 -fully-process -static -no-reduce-exports -pch -nomake examples -nomake demos -nomake docs -nomake tests -release -qt-sql-sqlite -no-dbus -qt-pcre -qt-zlib -qt-libpng -qt-libjpeg -openssl-linked -mysql_config no -sdk macosx10.8 -prefix ${MUMBLE_PREFIX}/Qt5.1 -opensource -confirm-license
make
make install
